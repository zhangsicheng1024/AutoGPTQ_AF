...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("QuantizeTensor_FT_Quant", QuantizeTensor_FT_Quant, "QuantizeTensor_FT_Quant");
    m.def("QuantizeTensor_FT_Dequant", QuantizeTensor_FT_Dequant, "QuantizeTensor_FT_Dequant");
